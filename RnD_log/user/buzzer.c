...
static u8 buzzer_volume = 1;	                	    /*!< Volume percentage for the buzzer, 0 - 100 (101 for full buzz) */
...
void buzzer_init()
{
  ...
  /* GPIO Init */ 
    timer_gpio_init(BUZZER_GPIO);
  
	AF_config(BUZZER_GPIO,GPIO_AF_TIM8);  // to be put in void easier
