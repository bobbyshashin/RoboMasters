...
void create_gtkdemo_trigger (GtkWidget *window)
{
    ...
    GtkWidget *pulse_entry   ;

    GtkWidget *d_button_confirm ;
    GtkWidget *p_button_confirm ;
    ...
    delay_entry  = GTK_WIDGET(gtk_builder_get_object(Demo_builder, "delay_entry"));
    pulse_entry  = GTK_WIDGET(gtk_builder_get_object(Demo_builder, "pulse_entry"));
    d_button_confirm  = GTK_WIDGET(gtk_builder_get_object(Demo_builder, "d_button_confirm"));
    p_button_confirm  = GTK_WIDGET(gtk_builder_get_object(Demo_builder, "p_button_confirm"));


    g_signal_connect ((gpointer) d_button_confirm, "pressed",G_CALLBACK (on_d_button_confirm_pressed),NULL);
    g_signal_connect ((gpointer) p_button_confirm, "pressed",G_CALLBACK (on_p_button_confirm_pressed),NULL);
    ...
    GLADE_HOOKUP_OBJECT (window, delay_entry, "delay_entry");
    GLADE_HOOKUP_OBJECT (window, pulse_entry, "pulse_entry");
    GLADE_HOOKUP_OBJECT (window, d_button_confirm, "d_button_confirm");
    GLADE_HOOKUP_OBJECT (window, p_button_confirm, "p_button_confirm");
...
void create_gtkdemo_exposure (GtkWidget *window,int hCamera,tSdkCameraCapbility * pCameraInfo)
{
    ...
    entry_exp_time= GTK_WIDGET(gtk_builder_get_object(Demo_builder, "entry_exp_time"));
    ...
    g_signal_connect(G_OBJECT(entry_exp_time), "activate",G_CALLBACK(on_entry_exp_time),NULL);
    ...
    GLADE_HOOKUP_OBJECT (window, entry_exp_time, "entry_exp_time");
