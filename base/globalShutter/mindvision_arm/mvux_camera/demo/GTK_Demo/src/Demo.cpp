...
int  Gtk_SetTrigger(int hCamera,tSdkCameraCapbility * pCameraInfo)
{
    ...
    GtkWidget *d_button_confirm   =lookup_widget(main_window, "d_button_confirm");
    GtkWidget *p_button_confirm   =lookup_widget(main_window, "p_button_confirm");
    ...
    switch(pbySnapMode){
        ...
        case 2:
            ...
            if(StrobeMode){
                ...
                CameraGetStrobePulseWidth(hCamera,&upTimeUs);
                CameraGetStrobeDelayTime(hCamera,&upDelayTimeUs);
