...
void cropRect(Rect& rect, Point tl, Point br, int x_offset_tl, int y_offset_tl, int x_offset_br, int y_offset_br) {

	Rect temp( Point(tl.x + x_offset_tl, tl.y + y_offset_tl), Point(br.x + x_offset_br, br.y + y_offset_br) );
	rect = temp;
